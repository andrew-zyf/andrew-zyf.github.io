...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(e,t,n){let r=new Float32Array(La),i=new J(0,1,0);return new Ei({name:`SphericalGaussianBlur`,defines:{n:La,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new Ei({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new Ei({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
	...
	`}var to=class extends Ht{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new fi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      void main() {
        ...
        #include <tonemapping_fragment>
        #include <colorspace_fragment>
      }`}),d=new ri(s,u,a);d.instanceMatrix.setUsage(Re),d.frustumCulled=!1,r.add(d);let f=new yn,p=innerWidth,m=innerHeight,h=()=>p<600,g=()=>h()?74:0,_=()=>h()?0:Wc,v=()=>Math.min(.62,(p-48)/(h()?800:1180),(m-170)/(h()?1150:680)),y=il(p,m),b=!0,x={x:0,y:0,zoom:y,vx:0,vy:0},S=0,C=0,w=!0,T=!1,E=!1,D=0,ee=0,O=0,k=`mouse`,te=null,A=null,j=null,M=null,N=null,P=null,F=new Map,I=new Set;function ne(){!S&&!document.hidden&&(S=requestAnimationFrame(de))}function re(){w=!0,ne()}function ie(e=!1){N=null,P=null,x.vx=0,x.vy=0,e||(j=null)}function ae(e){ie(),b=e,N={x:e?0:g(),y:e?0:_(),zoom:e?y:v()},hl.matches&&(Object.assign(x,N),N=null),re()}function oe(e,t=p/2,n=m/2,r=!1){let i=P?.zoom??N?.zoom??x.zoom;ie(),M=null;let a=St.clamp(i*e,y,1.8);if(a<=y*1.001){ae(!0);return}let[o,s]=rl(t-p/2,m/2-n,m),c=x.x+o/x.zoom,l=x.y+s/x.zoom;b=!1,r||hl.matches?(x.x=c-o/a,x.y=l-s/a,x.zoom=a):P={zoom:a,worldX:c,worldY:l,x:o,y:s},re()}function L(t,n){let[r,i]=rl(t-p/2,m/2-n,m),a=r/x.zoom+x.x,o=i/x.zoom+x.y,[s,c]=tl(a,o,h());for(let t=c-1;t<=c+1;t++)for(let n=s-1;n<=s+1;n++){if(Yc(n,t,h())||b&&!Jc(n,t,h()))continue;let[r,i]=Xc(n,t,h());if(Math.hypot(a-r,o-i)<=65){let r=$c(n,t,e.count,h());return r<0?null:{index:r,cell:[n,t]}}}return null}function se(t,n){if(A=t===null?null:n??el(t,h()),te=t,u.uniforms.uSelected.value=t??-1,cl.dataset.selected=t===null?``:e.people[t].handle,ml.hidden=t===null,t!==null){let n=e.people[t];document.querySelector(`#bubble-name`).textContent=n.displayName,document.querySelector(`#bubble-handle`).textContent=`@${n.handle}`,document.querySelector(`#bubble-bio`).textContent=(n.bio?n.bio+(n.bioTranslated?`

由 X / Grok 翻译`:``):``)||(n.bioStatus===`empty`?`这位朋友还没有填写个人简介。`:`暂时无法获取这位朋友的简介。`),document.querySelector(`#bubble-link`).href=`https://x.com/${encodeURIComponent(n.handle)}`}pl.textContent=t===null?`已取消选中。`:`${e.people[t].displayName}，@${e.people[t].handle}。双击或按 Enter 打开 X 主页。`,re()}function ce(t){window.open(`https://x.com/${encodeURIComponent(e.people[t].handle)}`,`_blank`,`noopener,noreferrer`)}function le(){if(te===null||!A){ml.hidden=!0;return}let[e,t]=Xc(...A,h()),n=(e-x.x)*x.zoom,r=(t-x.y)*x.zoom,[i,a]=nl(n,r,m),o=p/2+i,s=m/2-a,c=65*x.zoom*(1+Uc*(n*n+r*r)/(m*m));if(o<-c||o>p+c||s<-c||s>m+c){ml.hidden=!0;return}ml.hidden=!1,ml.style.maxHeight=``;let l=ml.offsetWidth,u=ml.offsetHeight,d=o+c+16,f=s-u/2;if(d+l>p-16&&(d=o-c-16-l,d<16)){d=o-l/2;let e=m-90-s-c-16,t=s-c-16-80,n=u<=e||u>t&&e>=t,r=Math.max(0,n?e:t);u>r&&(ml.style.maxHeight=`${r}px`,u=ml.offsetHeight),f=n?s+c+16:s-c-16-u}ml.style.left=`${Math.max(16,Math.min(d,p-l-16))}px`,ml.style.top=`${Math.max(80,Math.min(f,m-u-90))}px`}document.querySelector(`#bubble-close`).addEventListener(`click`,()=>{se(null),cl.focus({preventScroll:!0})});function ue(){let[t]=rl(p/2+148,0,m),[,n]=rl(0,m/2+148,m),[r,i]=tl(x.x-t/x.zoom,x.y-n/x.zoom,h()),[o,s]=tl(x.x+t/x.zoom,x.y+n/x.zoom,h()),c=0,u=0;for(let t=s-1;t<=i+1;t++)for(let n=r-2;n<=o+2;n++){if(Yc(n,t,h())||b&&!Jc(n,t,h()))continue;let r=$c(n,t,e.count,h());if(r<0)continue;let[i,o]=Xc(n,t,h()),[s,g]=nl((i-x.x)*x.zoom,(o-x.y)*x.zoom,m),_=148*x.zoom;Math.abs(s)>p/2+_||Math.abs(g)>m/2+_||c>=a||(f.position.set((i-x.x)*x.zoom,(o-x.y)*x.zoom,0),f.scale.setScalar(x.zoom),f.updateMatrix(),d.setMatrixAt(c,f.matrix),l.setX(c,r),c++,Jc(n,t,h())&&u++)}d.count=c,d.instanceMatrix.needsUpdate=!0,l.needsUpdate=!0;let[y,S]=nl((g()-x.x)*x.zoom,(_()-x.y)*x.zoom,m);ll.style.transform=`translate(calc(-50% + ${y}px), calc(-50% - ${S}px)) scale(${x.zoom})`,ll.dataset.compact=String(x.zoom<v()*.72),ll.hidden=Math.abs(y)>p+600*x.zoom||Math.abs(S)>m+400*x.zoom,fl.textContent=b?`回到中心`:`看见所有人`,cl.dataset.visiblePortraits=String(c),cl.dataset.primaryPortraits=String(u),cl.dataset.position=`${Math.round(x.x)},${Math.round(x.y)}`,cl.dataset.zoom=x.zoom.toFixed(4),cl.dataset.overview=String(b),le()}function de(e){S=0;let t=C?Math.min(e-C,40):16.667;if(C=e,P){x.zoom=hl.matches?P.zoom:ol(x.zoom,P.zoom,t);let e=Math.abs(Math.log(x.zoom/P.zoom))<1e-4;e&&(x.zoom=P.zoom),x.x=P.worldX-P.x/x.zoom,x.y=P.worldY-P.y/x.zoom,e&&(P=null),w=!0}else if(N){let e=hl.matches?1:al(t,110);x.x+=(N.x-x.x)*e,x.y+=(N.y-x.y)*e,x.zoom=hl.matches?N.zoom:ol(x.zoom,N.zoom,t),Math.abs(x.x-N.x)+Math.abs(x.y-N.y)<.05&&Math.abs(x.zoom-N.zoom)<5e-5&&(Object.assign(x,N),N=null),w=!0}else if(!F.size){if(I.size){let e=.5*t/x.zoom;I.has(`ArrowLeft`)&&(x.x-=e),I.has(`ArrowRight`)&&(x.x+=e),I.has(`ArrowUp`)&&(x.y+=e),I.has(`ArrowDown`)&&(x.y-=e),b=!1,w=!0}if(!hl.matches&&Math.hypot(x.vx,x.vy)*x.zoom>.015){let e=sl(x.vx,t),n=sl(x.vy,t);x.x+=e.distance,x.y+=n.distance,x.vx=e.velocity,x.vy=n.velocity,w=!0}else x.vx=0,x.vy=0}w&&=(ue(),n.render(r,i),!1),N||P||I.size||!F.size&&(x.vx||x.vy)?ne():C=0}function fe(){let e=h(),t=Math.abs(x.x-g())<1&&Math.abs(x.y-_())<1;if(p=innerWidth,m=innerHeight,y=il(p,m),e!==h()&&te!==null&&(A=el(te,h())),n.setSize(p,m),i.left=-p/2,i.right=p/2,i.top=m/2,i.bottom=-m/2,i.updateProjectionMatrix(),u.uniforms.uHeight.value=m,j!==null){if(A=el(j,h()),A){let[e,t]=Xc(...A,h());x.x=e,x.y=t,x.zoom=h()?.9:1.05}}else b?(x.zoom=y,x.x=0,x.y=0):t?(x.zoom=v(),x.x=g(),x.y=_()):x.zoom=Math.max(x.zoom,y);ie(!0),re()}cl.addEventListener(`wheel`,e=>{e.preventDefault();let t=e.deltaMode===1?16:e.deltaMode===2?m:1;if(e.ctrlKey||e.metaKey){oe(Math.exp(-e.deltaY*t*.006),e.clientX,e.clientY);return}let n=N??{x:x.x,y:x.y,zoom:x.zoom};ie(),b=!1,M=null;let r=n.x+e.deltaX*t/x.zoom,i=n.y-e.deltaY*t/x.zoom;hl.matches?(x.x=r,x.y=i):N={x:r,y:i,zoom:x.zoom},re()},{passive:!1}),cl.addEventListener(`pointerdown`,e=>{e.button!==0||F.size>=2||(k=e.pointerType,cl.dataset.keyboard=`false`,ie(),cl.setPointerCapture(e.pointerId),cl.focus({preventScroll:!0}),F.set(e.pointerId,{x:e.clientX,y:e.clientY,time:e.timeStamp}),F.size===1?(T=!1,E=!1,D=e.clientX,ee=e.clientY):(E=!0,M=null),u.uniforms.uHover.value=-1,O=e.timeStamp)}),cl.addEventListener(`pointermove`,e=>{let t=F.get(e.pointerId);if(!t){if(F.size)return;let t=L(e.clientX,e.clientY)?.index??-1;u.uniforms.uHover.value!==t&&(u.uniforms.uHover.value=t,re());return}let n=[...F.values()];if(F.set(e.pointerId,{x:e.clientX,y:e.clientY,time:e.timeStamp}),Math.hypot(e.clientX-D,e.clientY-ee)>5&&(T=!0),F.size>=2){let e=[...F.values()],t=Math.hypot(n[0].x-n[1].x,n[0].y-n[1].y),r=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y),i=(n[0].x+n[1].x)/2,a=(n[0].y+n[1].y)/2,o=(e[0].x+e[1].x)/2,s=(e[0].y+e[1].y)/2;if(t>0&&oe(r/t,i,a,!0),!b){let[e,t]=rl(i-p/2,m/2-a,m),[n,r]=rl(o-p/2,m/2-s,m);x.x+=(e-n)/x.zoom,x.y+=(t-r)/x.zoom}}else if(T){b=!1;let[n,r]=rl(t.x-p/2,m/2-t.y,m),[i,a]=rl(e.clientX-p/2,m/2-e.clientY,m),o=(n-i)/x.zoom,s=(r-a)/x.zoom;x.x+=o,x.y+=s;let c=Math.max(1,e.timeStamp-t.time),l=al(c,45),u=2.4/x.zoom;x.vx=hl.matches?0:x.vx+(St.clamp(o/c,-u,u)-x.vx)*l,x.vy=hl.matches?0:x.vy+(St.clamp(s/c,-u,u)-x.vy)*l,O=e.timeStamp}re()});let pe=e=>{if(!F.has(e.pointerId))return;F.delete(e.pointerId);let t=Math.max(0,1-(e.timeStamp-O)/100);if(e.type!==`pointerup`||E?(x.vx=0,x.vy=0):(x.vx*=t,x.vy*=t),F.size===1&&E){let t=[...F.values()][0];D=t.x,ee=t.y,t.time=e.timeStamp,T=!0}if(!F.size&&!T&&!E&&e.type===`pointerup`){let t=L(e.clientX,e.clientY);e.pointerType===`touch`&&t!==null&&M?.index===t.index&&e.timeStamp-M.time<350&&Math.hypot(e.clientX-M.x,e.clientY-M.y)<18?(ce(t.index),M=null):(se(t?.index??null,t?.cell),M=t===null||e.pointerType!==`touch`?null:{index:t.index,time:e.timeStamp,x:e.clientX,y:e.clientY})}else(T||E)&&(M=null);re()};cl.addEventListener(`pointerup`,pe),cl.addEventListener(`pointercancel`,pe),cl.addEventListener(`lostpointercapture`,pe),cl.addEventListener(`dblclick`,e=>{if(e.preventDefault(),T||E||k===`touch`)return;let t=L(e.clientX,e.clientY);t&&ce(t.index)}),cl.addEventListener(`pointerleave`,()=>{u.uniforms.uHover.value=-1,re()}),cl.addEventListener(`keydown`,e=>{if(e.key.startsWith(`Arrow`)&&(e.preventDefault(),ie(),I.add(e.key),re()),(e.key===`+`||e.key===`=`)&&(e.preventDefault(),oe(1.18)),e.key===`-`&&(e.preventDefault(),oe(1/1.18)),e.key===`0`&&(e.preventDefault(),ae(!0)),e.key===`Enter`){if(e.preventDefault(),te!==null)ce(te);else{let e=L(p/2,m/2)??L(p/2+p*.36,m/2);e!==null&&se(e.index,e.cell)}}}),window.addEventListener(`keydown`,()=>{cl.dataset.keyboard=`true`}),window.addEventListener(`keyup`,e=>I.delete(e.key)),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&!e.defaultPrevented&&(se(null),ae(!1),cl.focus({preventScroll:!0}))});function me(){I.clear(),F.clear(),x.vx=0,x.vy=0,M=null,C=0}window.addEventListener(`blur`,me),cl.addEventListener(`blur`,()=>I.clear()),window.addEventListener(`resize`,fe),document.addEventListener(`visibilitychange`,()=>{me(),document.hidden&&S?(cancelAnimationFrame(S),S=0):re()});let he=document.querySelector(`#people-search`),R=document.querySelector(`#search-input`),ge=document.querySelector(`#search-panel`),_e=document.querySelector(`#search-results`),ve=document.querySelector(`#search-status`),ye=document.querySelector(`#search-clear`),be=e=>e.normalize(`NFKC`).trim().toLocaleLowerCase(),xe=e.people.map((e,t)=>({index:t,handle:be(e.handle),name:be(e.displayName)})),Se=[],Ce=-1,we=!1;function Te(){ge.hidden=!0,R.setAttribute(`aria-expanded`,`false`),R.removeAttribute(`aria-activedescendant`),Ce=-1}function Ee(e){Ce=e,[..._e.children].forEach((t,n)=>t.setAttribute(`aria-selected`,String(n===e)));let t=_e.children[e];t?(R.setAttribute(`aria-activedescendant`,t.id),t.scrollIntoView({block:`nearest`})):R.removeAttribute(`aria-activedescendant`)}function De(t){let n=el(t,h());if(!n)return;ie(),I.clear(),b=!1,j=t;let[r,i]=Xc(...n,h());se(t,n),R.value=`@${e.people[t].handle}`,ye.hidden=!1,Te(),cl.focus({preventScroll:!0}),N={x:r,y:i,zoom:h()?.9:1.05},hl.matches&&(Object.assign(x,N),N=null),re()}function Oe(){ye.hidden=!R.value;let t=be(R.value).replace(/^@+/,``);if(_e.replaceChildren(),Se=[],!t){Te();return}let n=xe.map(e=>{let n=e.handle===t?0:e.name===t?1:e.handle.startsWith(t)?2:e.name.startsWith(t)?3:e.handle.includes(t)?4:e.name.includes(t)?5:-1;return{index:e.index,score:n}}).filter(e=>e.score>=0).sort((e,t)=>e.score-t.score||e.index-t.index);Se=n.slice(0,8).map(e=>e.index),ve.textContent=n.length?`${n.length} 位朋友${n.length>8?`，显示前 8 位`:``} · 选择头像即可定位`:`这次合影中暂时没有找到。试试完整的 @用户名。`,Se.forEach((t,n)=>{let r=e.people[t],i=document.createElement(`button`);i.type=`button`,i.className=`search-result`,i.id=`search-option-${t}`,i.setAttribute(`role`,`option`),i.tabIndex=-1;let a=document.createElement(`span`);a.className=`search-portrait`,a.setAttribute(`aria-hidden`,`true`),a.style.backgroundImage=`url("/my-x-friends/portraits.webp")`,a.style.backgroundSize=`${e.atlasColumns*100}% ${e.atlasRows*100}%`,a.style.backgroundPosition=`${t%e.atlasColumns/(e.atlasColumns-1)*100}% ${Math.floor(t/e.atlasColumns)/Math.max(1,e.atlasRows-1)*100}%`;let o=document.createElement(`span`);o.className=`search-identity`;let s=document.createElement(`span`);s.className=`search-name`,s.textContent=r.displayName;let c=document.createElement(`span`);c.className=`search-handle`,c.textContent=`@${r.handle}`,o.append(s,c),i.append(a,o),_e.append(i),i.addEventListener(`pointerdown`,e=>e.preventDefault()),i.addEventListener(`pointermove`,()=>Ee(n)),i.addEventListener(`click`,()=>De(t))}),ge.hidden=!1,R.setAttribute(`aria-expanded`,`true`),Ee(Se.length?0:-1)}R.addEventListener(`input`,()=>{we||Oe()}),R.addEventListener(`compositionstart`,()=>{we=!0}),R.addEventListener(`compositionend`,()=>{we=!1,Oe()}),R.addEventListener(`focus`,()=>{ie(),I.clear(),Oe()}),he.addEventListener(`submit`,e=>{e.preventDefault(),!we&&Se.length&&!ge.hidden&&De(Se[Math.max(0,Ce)])}),he.addEventListener(`keydown`,e=>{we||e.isComposing||(e.key===`Escape`&&(e.preventDefault(),e.stopPropagation(),Te()),e.target===R&&(e.key===`ArrowDown`||e.key===`ArrowUp`)&&(e.preventDefault(),ge.hidden?Oe():Se.length&&Ee((Ce+(e.key===`ArrowDown`?1:-1)+Se.length)%Se.length)))}),ye.addEventListener(`click`,()=>{R.value=``,Se=[],Te(),ye.hidden=!0,se(null),R.focus()}),document.addEventListener(`pointerdown`,e=>{he.contains(e.target)||Te()}),he.addEventListener(`focusout`,e=>{he.contains(e.relatedTarget)||Te()}),R.disabled=!1,document.querySelector(`#zoom-in`).addEventListener(`click`,()=>oe(1.3)),document.querySelector(`#zoom-out`).addEventListener(`click`,()=>oe(1/1.3)),fl.addEventListener(`click`,()=>ae(!b)),cl.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),dl.hidden=!1}),cl.addEventListener(`webglcontextrestored`,()=>location.reload()),fe(),ul.hidden=!0,document.body.dataset.ready=`true`,cl.dataset.ready=`true`,document.querySelector(`#collection-count`).textContent=`${e.count} 位已集合 · `,cl.dataset.portraitCount=String(e.count),pl.textContent=`已集合 ${e.count} 位朋友。`}_l().catch(e=>{console.error(`Portrait wall:`,e instanceof Error?e.message:`Loading failed`),ul.hidden=!0,dl.hidden=!1});